...
#     if letter =='d'
#         continue  #this will stop current
#    # if letter ==f:
...
result = my_dict.update({'key1': 'value3', 'key2': 'value2'})
print(result)
print(my_dict)
